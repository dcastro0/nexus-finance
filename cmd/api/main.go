...
import (
	...
	httpSwagger "github.com/swaggo/http-swagger/v2" // Import do Adapter
	"gorm.io/gorm"

	"github.com/dcastro0/nexus-finance/configs"
	_ "github.com/dcastro0/nexus-finance/docs" // Import IMPORTANTE: gerado pelo swag init
...
func main() {
	...
	// ... (Conexão DB e Repositories mantidos igual) ...
